#line 1 "/Users/corywiegert/SynologyDrive/Automated Dust Collection/gitHub/DustCollection_OTA/DustCollection_OTA/Library/ConfigStore.h"
...
bool config_init()
{
  EEPROM.begin(sizeof(ConfigStore)+ 200);   //CDW 03_10_2024, added the 200 bytes to the begin to accomidate the blast gate structure
  config_load();
  return true;
}
